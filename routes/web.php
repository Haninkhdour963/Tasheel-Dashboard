...
use App\Http\Controllers\Page\PaymentController as PagePaymentController;
...
Route::middleware(['auth'])->group(function () {
    ...
    // Page Routes (New routes for Chat, Payment, Job, Technician, and Client)
    Route::prefix('page')->group(function () {
        Route::resource('technicians', PageTechnicianController::class)->names('page.technicians');
        Route::resource('chats', PageChatController::class)->names('page.chats');
        Route::resource('payments', PagePaymentController::class)->names('page.payments');
        Route::resource('jobs', PageJobController::class)->names('page.jobs');
        Route::resource('clients', PageClientController::class)->names('page.clients');
    });
